local BASH = BASH;
local ITEM = {};
ITEM.ID =				"trenchcoat_black";
ITEM.Name =				"Black Trenchcoat";
...
ITEM.IsSuit =			true;
ITEM.PlayerModel =		Model("models/cakez/rxstalker/stalker_bandit/stalker_bandit3a.mdl");
ITEM.BodyArmor = 		3;
ITEM.BurnResist = 		3;
ITEM.AcidResist = 		3;
...
ITEM.Upgrades = {
    {"trenchcoat_black_reinf", 2500, {["fabric"] = 8}, {"ballistic_vest"}}
};
