local BASH = BASH;
local ITEM = {};
ITEM.ID =				"trenchcoat_brown";
ITEM.Name =				"Brown Trenchcoat";
...
ITEM.IsSuit =			true;
ITEM.PlayerModel =		Model("models/cakez/rxstalker/stalker_bandit/stalker_bandit4a.mdl");
ITEM.BodyArmor = 		3;
ITEM.BurnResist = 		3;
ITEM.AcidResist = 		3;
...
ITEM.Upgrades = {
    {"trenchcoat_brown_reinf", 2500, {["fabric"] = 8}, {"ballistic_vest"}}
};
