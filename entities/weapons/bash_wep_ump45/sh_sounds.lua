CustomizableWeaponry:addFireSound("CW_UMP45_FIRE", "weapons/cw_ump45/fire.wav", 1, 100, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_UMP45_FIRE_SUPPRESSED", "weapons/cw_ump45/fire_suppressed.wav", 1, 70, CHAN_STATIC)
