...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(2.675, 0, 0.55)
...
SWEP.Sounds = {	draw = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	...
	reload = {[1] = {time = 1.1, sound = "CW_AR15_MAGOUT"},
	[2] = {time = 1.9, sound = "CW_AR15_MAGIN"},
	[3] = {time = 2.6, sound = "CW_AR15_BOLT"}}}
...
SWEP.ViewModel		= "models/weapons/v_sg552.mdl"
SWEP.WorldModel		= "models/weapons/w_sg552.mdl"
