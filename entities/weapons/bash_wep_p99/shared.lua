...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-1.566, -3.346, 0.344)
	SWEP.IronsightAng = Vector(1.246, 0.123, 0.837)

	SWEP.ACOGPos = Vector(-2.247, -6.5, -0.602)
	SWEP.ACOGAng = Vector(0, 0, 0)

	SWEP.RMRPos = Vector(-1.647, -5.218, 0.256)
	SWEP.RMRAng = Vector(-0.143, -0.212, -0.139)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_rmr"] = {model = "models/wystan/attachments/2octorrds.mdl", bone = "Slide", pos = Vector(-0.231, -2.836, 2.115), angle = Angle(1.524, 0, 0), size = Vector(0.989, 0.989, 0.989)},
		["md_tundra9mm"] = {model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "Gun", pos = Vector(0.013, 6.747, 0.683), angle = Angle(0, 180, 0), size = Vector(0.917, 0.917, 0.917)}
	}
end
...
SWEP.Animations = {fire = {"shoot1", "shoot2"},
	...
	SWEP.Sounds = {reload_empty = {[1] = {time = 0.6, sound = "CW_P99_MAGOUT"},
	[2] = {time = 1.4, sound = "CW_P99_MAGIN"},
	[3] = {time = 1.91, sound = "CW_P99_SLIDE"}},

	draw = {[1] = {time = 0.2, sound = "CW_P99_SLIDE"},
	[2] = {time = 0.3, sound = "CW_P99_DRAW"}}}
...
SWEP.ViewModel		= "models/weapons/v_pist_p99a.mdl"
SWEP.WorldModel		= "models/weapons/w_pist_p99a.mdl"
