CustomizableWeaponry:addFireSound("CW_M14_FIRE", "weapons/cw_m14/fire.wav", 1, 105, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_M14_FIRE_SUPPRESSED", "weapons/cw_m14/fire_suppressed.wav", 1, 75, CHAN_STATIC)
