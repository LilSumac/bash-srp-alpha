CustomizableWeaponry:addFireSound("CW_G36C_FIRE", "weapons/cw_g36c/fire.wav", 1, 102, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_G36C_FIRE_SUPPRESSED", "weapons/cw_g36c/fire_suppressed.wav", 1, 75, CHAN_STATIC)
