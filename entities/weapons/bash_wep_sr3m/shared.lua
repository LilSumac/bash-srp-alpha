...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(4.67, 0, 1.5)
...
SWEP.Sounds = {	draw = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	...
	[2] = {time = 1, sound = "CW_AK74_MAGIN"},
	[3] = {time = 1.8, sound = "CW_AK74_BOLTPULL"}}}
...
SWEP.ViewModel		= "models/weapons/v_sr3m.mdl"
SWEP.WorldModel		= "models/weapons/w_sr3m.mdl"
