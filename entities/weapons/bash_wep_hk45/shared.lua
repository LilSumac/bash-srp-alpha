...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-2.342, -4.495, 0.947)
	SWEP.IronsightAng = Vector(-0.408, -0.084, 0)

	SWEP.ACOGPos = Vector(-2.247, -6.5, -0.602)
	SWEP.ACOGAng = Vector(0, 0, 0)

	SWEP.RMRPos = Vector(-2.284, -5.694, 0.569)
	SWEP.RMRAng = Vector(0.068, 0.203, 0)
	...
	SWEP.BoltBone = "slide"
	SWEP.BoltShootOffset = Vector(-1.7, 0, 0)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_saker"] = {model = "models/cw2/attachments/556suppressor.mdl", bone = "frame", pos = Vector(5.829, -0.413, -1.52), angle = Angle(0, -90, 0), size = Vector(0.5, 0.5, 0.5)},
		["md_rmr"] = {model = "models/wystan/attachments/2octorrds.mdl", bone = "slide", pos = Vector(2.022, -0.643, 0.24), angle = Angle(-90, 90, 0), size = Vector(0.89, 0.89, 0.89)},
...
SWEP.Sounds = {draw = {[1] = {time = 0.2, sound = "CW_GSH18_DRAW"}},
	reload = {[1] = {time = 0.42, sound = "CW_COMPACT45_MAGOUT"},
	[2] = {time = 1.2, sound = "CW_COMPACT45_MAGIN"},
	[3] = {time = 2, sound = "CW_COMPACT45_SLIDE"}}
}
...
SWEP.ViewModel		= "models/weapons/v_pist_co45.mdl"
...
SWEP.FireDelay = 0.1
SWEP.FireSound = "CW_COMPACT45_FIRE"
