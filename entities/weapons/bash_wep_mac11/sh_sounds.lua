CustomizableWeaponry:addFireSound("CW_MAC11_FIRE", "weapons/cw_mac11/fire.wav", 1, 95, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_MAC11_FIRE_SUPPRESSED", "weapons/cw_mac11/fire_suppressed.wav", 1, 70, CHAN_STATIC)
