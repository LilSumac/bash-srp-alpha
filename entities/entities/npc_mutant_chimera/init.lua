...
ENT.attack1 = Sound("misses/miss1.wav")
ENT.attack2 = Sound("misses/miss2.wav")
ENT.attack3 = Sound("misses/miss3.wav")
ENT.attack4 = Sound("misses/miss4.wav")
ENT.attack5 = Sound("misses/miss1.wav")
ENT.attack6 = Sound("misses/miss2.wav")
...
ENT.model1 = "models/stalkertnb/chimera1.mdl"
ENT.model2 = "models/stalkertnb/chimera1.mdl"
	...
	local function Attack_Melee()
		...
		if entstoattack != nil then
			for _,v in pairs(entstoattack) do
				if ( (v:IsNPC() or ( v:IsPlayer() and v:Alive() and !v:GetEntry("Observing") and self:Disposition(v) == 1)) and (v != self) and (v:GetClass() != self:GetClass()) or (v:GetClass() == "prop_physics")) then
