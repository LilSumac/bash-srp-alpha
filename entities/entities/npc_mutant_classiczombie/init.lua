...
ENT.model1 = "models/stalkertnb/zombie1.mdl"
ENT.model2 = "models/stalkertnb/zombie2.mdl"
	...
	local function Attack_Melee()
		...
		if entstoattack != nil then
			for _,v in pairs(entstoattack) do
				if ( (v:IsNPC() or ( v:IsPlayer() and v:Alive() and !v:GetEntry("Observing") and self:Disposition(v) == 1 and !v:GetEntry("Observing"))) and (v != self) and (v:GetClass() != self:GetClass()) or (v:GetClass() == "prop_physics")) then
